...
public class Agregar_Farmaco extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(vacio(jTextField1)+vacio(jTextField2)+vacio(jTextField3)+vacio(jTextArea1) != 4){
            ...
            JOptionPane.showMessageDialog(null,"Farmaco Agregado","Agregando Farmaco",JOptionPane.INFORMATION_MESSAGE);
            c1.mostrar_datos("");
            dispose();
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Agregar_Farmaco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Agregar_Farmaco().setVisible(true);
            }
        });
    }
